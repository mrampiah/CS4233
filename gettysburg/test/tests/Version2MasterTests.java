...
import static engine.Factory.makeTestGame;
...
public class Version2MasterTests
{
	...
	public void setup()
	{
		...
		rowley = Unit.makeUnit(UNION, 3,2, NORTHEAST, "Rowley",  DIVISION, INFANTRY);
		schurz = Unit.makeUnit(UNION, 2, 2,  NORTH, "Schurz", DIVISION, INFANTRY);
		rodes = Unit.makeUnit(CONFEDERATE, 4, 2,  SOUTH, "Rodes", DIVISION, INFANTRY);
		dance = Unit.makeUnit(CONFEDERATE, 2, 4,  EAST, "Dance", BATTALION, ARTILLERY);
		hampton = Unit.makeUnit(CONFEDERATE, 1, 4,  SOUTH, "Hampton",  BRIGADE, CAVALRY);
...
//		heth.setFacing(EAST);
	...
	{
	    Collection<GbgUnit> units = new HashSet<>(game.getUnitsAt(makeCoordinate(7, 28)));
		Iterator<GbgUnit> iterator = units.iterator();
		game.moveUnit(iterator.next(), makeCoordinate(7, 28), makeCoordinate(5, 28));
		game.moveUnit(iterator.next(), makeCoordinate(7, 28), makeCoordinate(6, 28));
		game.moveUnit(iterator.next(), makeCoordinate(7, 28), makeCoordinate(8, 28));
		game.moveUnit(iterator.next(), makeCoordinate(7, 28), makeCoordinate(9, 28));
	...
	public void someEntryUnitsRemainAndAreRemoved()
	{
		...
		game.moveUnit(Unit.makeUnit(iterator.next()), makeCoordinate(7, 28), makeCoordinate(5, 28));
		game.moveUnit(Unit.makeUnit(iterator.next()), makeCoordinate(7, 28), makeCoordinate(6, 28));
		Collection<GbgUnit> remaining = game.getUnitsAt(makeCoordinate(7, 28));
