...
public class Version1MasterTests {
    ...
    public void testDirectionToNorth() {
        Direction d = CoordinateImpl.makeCoordinate(2, 2).directionTo(CoordinateImpl.makeCoordinate(2, 1));
        assertTrue(d.equals(NORTH));
    }

    @Test
    public void testDirectionToSouth() {
        Direction d = CoordinateImpl.makeCoordinate(1, 1).directionTo(CoordinateImpl.makeCoordinate(1, 2));
        assertTrue(d.equals(SOUTH));
    }

    @Test
    public void testDirectionToEast() {
        Direction d = CoordinateImpl.makeCoordinate(1, 1).directionTo(CoordinateImpl.makeCoordinate(2, 1));
        assertTrue(d.equals(EAST));
    }

    @Test
    public void testDirectionToWest() {
        Direction d = CoordinateImpl.makeCoordinate(5, 5).directionTo(CoordinateImpl.makeCoordinate(4, 5));
        assertTrue(d.equals(WEST));
    }

    @Test
    public void testDirectionToNorthWest() {
        Direction d = CoordinateImpl.makeCoordinate(5, 5).directionTo(CoordinateImpl.makeCoordinate(4, 4));
        assertTrue(d.equals(NORTHWEST));
    }

    @Test
    public void testDirectionToSouthWest() {
        Direction d = CoordinateImpl.makeCoordinate(5, 5).directionTo(CoordinateImpl.makeCoordinate(4, 6));
        assertTrue(d.equals(SOUTHWEST));
    }


    @Test
    public void testDirectionToNorthEast() {
        Direction d = CoordinateImpl.makeCoordinate(5, 5).directionTo(CoordinateImpl.makeCoordinate(6, 4));
        assertTrue(d.equals(NORTHEAST));
    }

    @Test
    public void testDirectionToSouthEast() {
        Direction d = CoordinateImpl.makeCoordinate(5, 5).directionTo(CoordinateImpl.makeCoordinate(6, 6));
        assertTrue(d.equals(SOUTHEAST));
    }
}
